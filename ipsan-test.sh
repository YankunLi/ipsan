...
#author : liyankun
#date : 20150412
#GET v2/{tenant_id}/ os-ipsans list()
#POST v2/{tenant_id}/ os-ipsans  create()
#GET v2/{tenant_id}/ os-ipsans/{ipsan_id} show()
#PUT v2/{tenant_id}/ os-ipsans/{ipsan_id} update()
#DELETE v2/{tenant_id}/ os-ipsans/{ipsan_id}  delete()
ID=$2
